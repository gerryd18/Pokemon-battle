...
public class Squirtle extends Pokemon{
	...
	public Squirtle(String name, String[] skillAttack, String element, String weakness) {
	...
	public int getAttack(String skillAttack) {
		...
		if (skillAttack.equals("Takle")) {
			attack = 20;
		}else if (skillAttack.equals("Waterball")) {
			attack = 30;	
		}else if (skillAttack.equals("Watercanon")) {
			attack = 40;
		}
		return attack;
	}
